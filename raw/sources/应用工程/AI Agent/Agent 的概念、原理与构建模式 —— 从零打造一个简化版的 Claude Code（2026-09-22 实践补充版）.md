---
title: Agent 的概念、原理与构建模式 —— 从零打造一个简化版的 Claude Code（2026-09-22 实践补充版）
...
# Agent 的概念、原理与构建模式 —— 从零打造一个简化版的 Claude Code（2026-09-22 实践补充版）
...
本节是知识库维护时依据作者公开源码与官方教程补充的复现说明，不是视频原话，也不表示已完成模型调用或游戏验收。此前正文保持原貌；2025-07-22 是视频发布日期，2026-09-22 是本节核验日期。
...
版本关系：本补充版保留 [[raw/sources/应用工程/AI Agent/Agent 的概念、原理与构建模式 —— 从零打造一个简化版的 Claude Code|初版]] 的正文，并新增实践入口与运行前提；外部代码和教程的核验范围、固定提交及限制见补充章节。
