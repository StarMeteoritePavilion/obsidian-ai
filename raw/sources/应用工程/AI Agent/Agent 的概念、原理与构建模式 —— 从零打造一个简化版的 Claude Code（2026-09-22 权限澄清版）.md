---
title: Agent 的概念、原理与构建模式 —— 从零打造一个简化版的 Claude Code（2026-09-22 权限澄清版）
...
# Agent 的概念、原理与构建模式 —— 从零打造一个简化版的 Claude Code（2026-09-22 权限澄清版）
...
本节是知识库维护时依据作者公开源码与官方教程补充的复现说明，不是视频原话，也不表示已完成模型调用或游戏验收。本版保留实践补充内容，并澄清正文的目录参数表述；2025-07-22 是视频发布日期，2026-09-22 是补充与澄清的核验日期。
...
版本关系：本版承接 [[raw/sources/应用工程/AI Agent/Agent 的概念、原理与构建模式 —— 从零打造一个简化版的 Claude Code（2026-09-22 实践补充版）|实践补充版]]，修正“可以操作的项目目录”的权限歧义并增加源码边界说明；[[raw/sources/应用工程/AI Agent/Agent 的概念、原理与构建模式 —— 从零打造一个简化版的 Claude Code|初版]] 与实践补充版均完整保留。
