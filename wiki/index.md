...
本知识库收录 26 份资料摘要和 4 篇跨资料综合，沿 Prompt、Context、Loop、Evaluation 四个阶段组织 AI 应用工程。原始事实保存在 `raw/sources/`，本目录负责摘要、关联、冲突记录与综合判断。
...
- 评估工程系列资料标注为共八期，当前知识库已收录前七期；第八期“企业级评估工程”尚无原始资料。
